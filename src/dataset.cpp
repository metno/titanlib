...
void titanlib::Dataset::sct_resistant(const ivec& obs_to_check,
    ...
    ivec new_flags = titanlib::sct_resistant(get_unflagged_points(),
            ...
            get_unflagged(background_values),
            ...
            vertical_scale,
            get_unflagged(value_mina),
            get_unflagged(value_maxa),
            get_unflagged(value_minv),
            get_unflagged(value_maxv),
            get_unflagged(eps2),
            get_unflagged(tpos),
            get_unflagged(tneg),
            debug,
