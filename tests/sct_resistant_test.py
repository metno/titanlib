...
#        print("===============================================================")
    ...
    def test_time(self):
        ...
        points = titanlib.Points(lats, lons, elevs)
        flags, score = titanlib.sct_resistant(points, values, obs_to_check, background_values,
                ...
                max_horizontal_scale, kth_closest_obs_horizontal_scale, vertical_scale, values_mina,
                values_maxa, values_minv, values_maxv, eps2, tpos, tneg, debug, basic)
